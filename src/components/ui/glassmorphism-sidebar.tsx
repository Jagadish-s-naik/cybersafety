...
type PageType = keyof typeof pageContent;
...
const Sidebar = ({ activePage, setActivePage }: { activePage: PageType; setActivePage: (page: PageType) => void }) => (
...
const MainContent = ({ activePage }: { activePage: PageType }) => {
